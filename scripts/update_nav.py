...
files_to_update = {
    'services/frontend_service/app/templates/meta-learning.html': {'dash_active': '', 'forecast_active': '', 'ai_active': ' active', 'analytics_active': ''},
    'services/frontend_service/app/templates/advanced.html': {'dash_active': '', 'forecast_active': '', 'ai_active': ' active', 'analytics_active': ''},
    'services/frontend_service/app/templates/causal.html': {'dash_active': '', 'forecast_active': '', 'ai_active': ' active', 'analytics_active': ''},
    'services/frontend_service/app/templates/analytics.html': {'dash_active': '', 'forecast_active': '', 'ai_active': '', 'analytics_active': ' active'},
}
